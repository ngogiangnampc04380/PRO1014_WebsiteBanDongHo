    ...
    <div id="mainSlider" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://lh3.googleusercontent.com/pw/AP1GczMvEV0SMhlmJ7i12_E58Mhe_ByCduhJpW6vKKhxd0XWGvplS6-J2Y3yomX-plGjJoWpnMG0noN7EK4dvKTLp8rS0v2wani04IC9R3yh3Xvm5Xs4TIxNngrOxxA1zTT13Id31pJM9e46AEmSDV6m4hZR=w2048-h596-s-no?authuser=0" class="d-block w-100" alt="...">
            </div>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="room-btn pt-70">
                    <a href="catagori.html" class="btn view-btn1">Tất cả sản phẩm</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-method mb-40">
                            ...
                            <h6>Phương thứ thanh toán an toàn</h6>
